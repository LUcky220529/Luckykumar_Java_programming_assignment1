...
class Account {
    ...
    Account(int accountNumber, String accountHolderName, double balance, String email, int phoneNumber) {
    ...
    void updateContactDetails(String email, int phoneNumber) {
...
class UserInterface {
    ...
    void updateContact() {
        ...
        if (acc != null) {
            ...
            int newPhone = sc.nextInt();   // Now int
